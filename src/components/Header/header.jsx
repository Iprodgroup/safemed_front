...
const Header = ({ country, number, email }) => {
          ...
          <div className="container">
            <div className=" w-full py-4 flex items-center justify-between px-4">
              ...
              <div className="flex items-center gap-8 menu">
                <button
                  onClick={closeNav}
                  className="text-white 2xl:hidden xl:hidden lg:hidden absolute
                ...
                <div className="flex gap-8 msg">
                  <div
                    className=" 2xl:text-lg xl:text-md lg:text-md md:text-sm sm:text-sm text-sm 
